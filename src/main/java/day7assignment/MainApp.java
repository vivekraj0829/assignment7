...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("\n===== NETFLIX DASHBOARD =====");
            System.out.println("1. High Rated Movies");
            System.out.println("2. Genre Distribution");
            System.out.println("3. Top 5 Trending Movies");
            System.out.println("4. Genre-wise Performance");
            System.out.println("5. Completion Rate Analysis");
            ...
            switch (choice) {
                ...
                case 1:
                    System.out.println("\n1. HIGH-RATED MOVIES (Rating > 8.0)");
                    movies.stream()
                            .filter(m -> m.rating > 8)
                            .forEach(m -> System.out.println(
                                    " - " + m.title + " (" + m.genre + ", " + m.rating + ", " + m.releaseYear + ")"
                            ));
                    break;
                ...
                case 4:
                    ...
                    for (String g : grouped.keySet()) {
                        ...
                        Movie top = list.stream()
                                .max(Comparator.comparingDouble(m -> m.rating)).get();
